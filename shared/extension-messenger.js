...
// At the end of extension-messenger.js, replace the export with:
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { ExtensionMessenger, createMessenger, detectContext };
} else if (typeof window !== 'undefined') {
    window.ExtensionMessenger = ExtensionMessenger;
    window.createMessenger = createMessenger;
